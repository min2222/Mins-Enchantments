...
public class EnchantmentSailing extends AbstractOceanEnchantment
{
	...
	{
		return this.getMinCost(pLevel) + EnchantmentConfig.sailingMaxCost.get();
	}
	
	@Override
	public int getMinCost(int pLevel) 
	{
		return EnchantmentConfig.sailingMinCost.get() + (pLevel - 1) * EnchantmentConfig.sailingMaxCost.get();
	}
