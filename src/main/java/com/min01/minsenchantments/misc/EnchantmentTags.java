...
public class EnchantmentTags 
{
	...
	public static final String RAGE_SPEED = "RageSpeed";
	public static final String RAGE_SPEED_ORIGINAL = "RageSpeedOriginal";
	...
	public static final String IS_AUTO_SHIELDING = "IsAutoShielding";
	public static final String GRINDING = "Grinding";
	public static final String GRINDING_DMG = "GrindingDmg";
	public static final String GRINDING_SPEED = "GrindingSpeed";
	public static final String GRINDING_PROJECTILE = "GrindingProj";
	public static final String GRINDING_MINING = "GrindingMining";
	public static final String GRINDING_DMG_COUNT = "GrindingDmgCount";
	public static final String GRINDING_SPEED_COUNT = "GrindingSpeedCount";
