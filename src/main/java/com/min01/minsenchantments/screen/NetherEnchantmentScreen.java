...
public class NetherEnchantmentScreen extends AbstractCustomEnchantmentScreen<NetherEnchantmentMenu>
{
	...
	{		
		...
		stack.mulPose(Vector3f.YP.rotationDegrees(this.tickCount));
		this.minecraft.getItemRenderer().renderStatic(new ItemStack(Items.WITHER_SKELETON_SKULL), ItemTransforms.TransformType.HEAD, 15728880, OverlayTexture.NO_OVERLAY, stack, multibuffersource$buffersource, 0);
		stack.popPose();
	...
	private void renderFlame(PoseStack p_114454_, MultiBufferSource p_114455_)
	{
		...
		float f3 =1 / f;
		float f4 = 0.0F;
		p_114454_.mulPose(Vector3f.YP.rotationDegrees(180));
