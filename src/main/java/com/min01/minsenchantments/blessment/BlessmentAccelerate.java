...
public class BlessmentAccelerate extends AbstractBlessment
{
	...
	{
		return this.getMinCost(pLevel) + EnchantmentConfig.accelerateMaxCost.get();
	}
	
	@Override
	public int getMinCost(int pLevel) 
	{
		return EnchantmentConfig.accelerateMinCost.get() + (pLevel - 1) * EnchantmentConfig.accelerateMaxCost.get();
	}
