...
public class EnchantmentTags 
{
	...
	public static final String SKILLFUL_PROJECTILE = "SkillfulProj";
	public static final String SKILLFUL_MINING = "SkillfulMining";
	public static final String SKILLFUL_DMG_COUNT = "SkillfulDmgCount";
	public static final String SKILLFUL_SPEED_COUNT = "SkillfulSpeedCount";
	public static final String SKILLFUL_PROJECTILE_COUNT = "SkillfulProjCount";
	public static final String SKILLFUL_MINING_COUNT = "SkillfulMiningCount";
