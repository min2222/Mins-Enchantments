...
public class CustomMenuType
{
    ...
    public static final RegistryObject<MenuType<SculkEnchantmentMenu>> SCULK_ENCHANTMENT = MENUS.register("sculk_enchantment", () -> new MenuType<>(SculkEnchantmentMenu::new, FeatureFlags.DEFAULT_FLAGS));
    public static final RegistryObject<MenuType<BlessmentMenu>> BLESSMENT = MENUS.register("blessment", () -> new MenuType<>(BlessmentMenu::new, FeatureFlags.DEFAULT_FLAGS));
}
